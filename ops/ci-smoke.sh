...
test "$(stat -c '%u:%g:%a' "${DATA_ROOT}")" = "65532:65532:750"
test "$(stat -c '%u:%g:%a' "${DATA_ROOT}/assets")" = "65532:65532:750"
test "$(stat -c '%u:%g:%a' "${DATA_ROOT}/uploads")" = "65532:65532:700"
test "$(stat -c '%u:%g:%a' "${DATA_ROOT}/uploads/tmp")" = "65532:65532:700"
test "$(stat -c '%u:%g:%a' "${DATA_ROOT}/uploads/quarantine")" = "65532:65532:700"
